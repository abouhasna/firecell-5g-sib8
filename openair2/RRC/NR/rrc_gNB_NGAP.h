...
void rrc_gNB_send_NGAP_INITIAL_CONTEXT_SETUP_FAIL(const protocol_ctxt_t *const ctxt_pP,
...
void rrc_gNB_send_NGAP_HANDOVER_CANCEL(const protocol_ctxt_t *const ctxt_pP, rrc_gNB_ue_context_t *const ue_context_pP, uint8_t xid, uint8_t cause);

void rrc_gNB_send_NGAP_HANDOVER_FAILURE(const module_id_t gnb_mod_id,
                                      uint32_t     gnb_ue_id,
                                      uint8_t      xid,
                                      uint8_t      cause,
                                      uint64_t amf_ue_id);
