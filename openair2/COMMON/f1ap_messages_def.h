...
MESSAGE_DEF(F1AP_GNB_DU_CONFIGURATION_UPDATE,
...
MESSAGE_DEF(F1AP_GNB_DU_CONFIGURATION_UPDATE_ACKNOWLEDGE,
            MESSAGE_PRIORITY_MED,
            f1ap_gnb_du_configuration_update_acknowledge_t,
            f1ap_gnb_du_configuration_update_acknowledge)
MESSAGE_DEF(F1AP_GNB_DU_CONFIGURATION_UPDATE_FAILURE,
            MESSAGE_PRIORITY_MED,
