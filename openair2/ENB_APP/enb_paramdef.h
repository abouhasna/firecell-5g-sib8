...
//NSA NR Band
#define ENB_CONFIG_STRING_NR_BAND                                       "nr_band"
...
#define CCPARAMS_DESC(ccparams) {					\
  ...
  {ENB_CONFIG_STRING_NR_BAND,                                      NULL,   0,           .iptr=&ccparams.nr_band,                                  .defintval=77,              TYPE_INT,        0},  \
}
// clang-format on
...
#define ENB_CONFIG_NR_BAND_IDX                                     77
