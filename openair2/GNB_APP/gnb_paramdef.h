...
#define GNB_CONFIG_UE_RELEASE "UE_Release_on_assert_Flag"
...
{GNB_CONFIG_UE_RELEASE,                      NULL,  PARAMFLAG_BOOL,            .iptr=NULL,  .defintval=1,                 TYPE_UINT,           0},  \
}
// clang-format on
...
#define GNB_CONFIG_UE_RELEASE_IDX 32

#define TRACKING_AREA_CODE_OKRANGE {0x0001,0xFFFD}
#define GNBPARAMS_CHECK                                                                                                          \
  {                                                                                                                              \
    {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s2 = {config_check_intrange, TRACKING_AREA_CODE_OKRANGE}}, {.s5 = {NULL}}, \
        {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}},          \
        {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}},          \
        {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}},          \
        {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}}, {.s5 = {NULL}},                          \
  }
...
#define CONFIG_STRING_COLLECTOR_DU "du_collector_config"
#define CONFIG_STRING_COLLECTOR_CU "cu_collector_config"

#define GNB_CONFIG_STRING_TELNET_PORT "telnet_port"
#define GNB_CONFIG_STRING_HTTP_PORT "http_port"
#define GNB_CONFIG_STRING_HTTP_HOST "http_host"
#define GNB_CONFIG_STRING_TELNET_HOST "telnet_host"

#define COLLECTOR_GLOBAL_PARAMS_CU_DESC                                                                               \
  {                                                                                                                   \
    {GNB_CONFIG_STRING_TELNET_PORT, "cu_collector_config", 0, .uptr = NULL, .defintval = 9099, TYPE_UINT, 0},            \
        {GNB_CONFIG_STRING_HTTP_PORT, "cu_collector_config", 0, .uptr = NULL, .defintval = 7035, TYPE_UINT, 0},          \
        {GNB_CONFIG_STRING_HTTP_HOST, "cu_collector_config", 0, .strptr = NULL, .defstrval = "127.0.0.1", TYPE_STRING, 0},   \
        {GNB_CONFIG_STRING_TELNET_HOST, "cu_collector_config", 0, .strptr = NULL, .defstrval = "127.0.0.1", TYPE_STRING, 0}, \
  }

#define CU_COLLECTOR_TELNET_PORT_IDX 0
#define CU_COLLECTOR_HTTP_PORT_IDX 1
#define CU_COLLECTOR_HTTP_HOST_IDX 2
#define CU_COLLECTOR_TELNET_HOST_IDX 3

#define GNB_CONFIG_STRING_DU_REDIS_PORT "redis_port"
#define GNB_CONFIG_STRING_DU_REDIS_HOST "redis_host"
#define GNB_CONFIG_STRING_DU_HTTP_PORT "http_port"
#define GNB_CONFIG_STRING_DU_HTTP_HOST "http_host"

#define COLLECTOR_GLOBAL_PARAMS_DU_DESC                                                                                 \
  {                                                                                                                     \
    {GNB_CONFIG_STRING_DU_REDIS_PORT, "du_collector_config", 0, .uptr = NULL, .defintval = 6379, TYPE_UINT, 0},            \
        {GNB_CONFIG_STRING_DU_REDIS_HOST, "du_collector_config", 0, .strptr = NULL, .defstrval = "127.0.0.1", TYPE_STRING, 0}, \
        {GNB_CONFIG_STRING_DU_HTTP_PORT, "du_collector_config", 0, .uptr = NULL, .defintval = 8035, TYPE_UINT, 0},         \
        {GNB_CONFIG_STRING_DU_HTTP_HOST, "du_collector_config", 0, .strptr = NULL, .defstrval = "127.0.0.1", TYPE_STRING, 0},  \
  }

#define DU_COLLECTOR_REDIS_PORT_IDX 0
#define DU_COLLECTOR_REDIS_HOST_IDX 1
#define DU_COLLECTOR_HTTP_PORT_IDX 2
#define DU_COLLECTOR_HTTP_HOST_IDX 3
