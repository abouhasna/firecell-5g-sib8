...
#define CONFIG_STRING_MACRLC_NR_SCHED_MODE                 "scheduler_mode"
...
#define HLP_MACRLC_NR_SCHED_MODE "MAC scheduler modes options are fairRR or fcPriorityBased"
...
#define MACRLCPARAMS_DESC { \
  ...
  {CONFIG_STRING_MACRLC_NR_SCHED_MODE,               NULL,                     0, .strptr=NULL, .defstrval="fairRR",        TYPE_STRING,  0}, \
}
// clang-format off
...
#define MACRLC_NR_SCHED_MODE_IDX                               33
