...
#define CONFIG_HLP_QOS           "enable QoS aware scheduling algorithm\n"
...
#define QOS_SCHED           softmodem_params.qos_sched
...
#define CMDLINE_PARAMS_DESC {  \
  ...
  {"qos-sched",             CONFIG_HLP_QOS,           PARAMFLAG_BOOL, .iptr=&QOS_SCHED,                       .defintval=0,             TYPE_INT,    0},  \
